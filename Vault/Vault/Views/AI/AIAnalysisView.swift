...
//  Vault
//
//  Full-screen AI Analysis sheet: Claude's portfolio commentary, factual risk
//  metric cards, suggestion chips and an "Ask Claude" follow-up field.
//
...
struct AIAnalysisView: View {
    ...
    init(holdings: [Holding], summary: PortfolioSummary, currency: DisplayCurrency = .gbp) {
    ...
    var body: some View {
        ...
        .task {
            viewModel.prepare(holdings: holdings, summary: summary)
    ...
    private var header: some View {
        HStack(spacing: 14) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                Text("Portfolio analysis").font(.system(size: 21, weight: .semibold)).foregroundStyle(Theme.ink)
                Text("Generated by Claude · \(viewModel.generatedAt.formatted(.dateTime.day().month(.abbreviated).year().hour().minute()))")
                ...
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    if viewModel.isLoading {
                        HStack(spacing: 8) {
                            ...
                            Text("Claude is thinking…").font(.system(size: 14)).foregroundStyle(Theme.inkDim)
                        }
                        .id("loading")
                    }
                }
    ...
    private var askBar: some View {
        VStack(spacing: 12) {
            ...
            HStack(spacing: 12) {
                TextField("Ask Claude about your portfolio…", text: $draft)
