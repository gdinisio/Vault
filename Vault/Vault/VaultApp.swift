...
struct VaultApp: App {
    ...
    let container: ModelContainer = {
        ...
        do {
            ...
            let fallback = ModelConfiguration(schema: Schema([Holding.self, PaperPosition.self, PaperTrade.self, WatchItem.self, WatchlistGroup.self]), isStoredInMemoryOnly: true)
